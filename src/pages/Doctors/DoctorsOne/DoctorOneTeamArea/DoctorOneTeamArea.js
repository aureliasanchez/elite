        ...
        <>
            <section className="team-area pt-115 pb-55">
                <div className="container">
                    ...
                    <div className="row centrarObjetos">
                        <HomeSingleTeam image="1" title="Dr. Jesús Tadeo Moreno Aranda." subtitle="Cirugía Estética y Medicina Estética" description="Es un cirujano estético con más de 10 años de experiencia en el campo de la medicina estética. Fundador de Elite Esthetic en 2018, se ha destacado por su compromiso con la excelencia y la atención personalizada a cada paciente. Su enfoque en el uso de tecnologías avanzadas y técnicas innovadoras lo posiciona como un líder en su área." />
                    </div>
                </div>
            </section>
        </>
